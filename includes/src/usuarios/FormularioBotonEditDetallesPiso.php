...
class FormularioBotonEditDetallesPiso extends Form{

    private $id_piso;

    public function __construct($id_piso) {
        parent::__construct('formEditDetallesPiso_'.$id_piso, ['urlRedireccion' => Aplicacion::getInstance()->resuelve('/edit_piso.php')]);
    ...
    protected function generaCamposFormulario($datos)
    {
        ...
        $id_form = 'formEditDetallesPiso_'.$this->id_piso;
        $formulario = <<<EOS
